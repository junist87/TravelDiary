...
public interface SqlHandler {
     ...
     */
    SqlProduct getSqlProduct(Object vo, SqlType type, List<AttachStatement> statements);
     ...
     * @return the sql product
     */
    SqlProduct getSqlProduct(Class voInfo, SqlType type, List<AttachStatement> statements);
     ...
     * @return the sql product
     */
    SqlProduct getSqlProduct(Class voInfo, SqlType type);
     ...
     * @return the sql product
     */
    SqlProduct getSqlProduct(Object vo, SqlType type);
}
